...
ApplicationWindow {
    ...
    component SidebarButton: Rectangle {
        ...
        color: isActive ? "#1e293b" : "transparent"
        radius: 8
    ...
    component StatCard: Rectangle {
        ...
        property color iconBg: "transparent" // Default
        Layout.fillWidth: true; Layout.preferredHeight: 100
        color: theme.cardColor; radius: 12; border.color: theme.borderColor; border.width: 1
        RowLayout {
            anchors.fill: parent; anchors.margins: 20; spacing: 15
            Rectangle { Layout.preferredWidth: 48; Layout.preferredHeight: 48; radius: 12; color: iconBg; VectorIcon { anchors.centerIn: parent; name: iconName; color: iconColor } }
            ColumnLayout { spacing: 4; Text { text: title; color: theme.subTextColor; font.pixelSize: 13; font.weight: Font.Medium } Text { text: value; color: "white"; font.pixelSize: 22; font.bold: true } }
        }
    }
            ...
            StackLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        // ИСПРАВЛЕННЫЙ ЦВЕТ ФОНА (HEX с прозрачностью)
                        StatCard {
                            title: "Доход"; value: "+" + mainWindow.budget.toFixed(2);
                            iconName: "arrow_up"; iconColor: theme.incomeColor;
                            iconBg: "#3310b981"
                        }
                        StatCard {
                            title: "Расход"; value: "−" + mainWindow.spent.toFixed(2);
                            iconName: "arrow_down"; iconColor: theme.expenseColor;
                            iconBg: "#33ef4444"
                        }
                    }
                    Rectangle {
